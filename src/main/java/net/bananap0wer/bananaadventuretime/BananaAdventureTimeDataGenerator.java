...
import net.bananap0wer.bananaadventuretime.datagen.ModRegistryDataGenerator;
...
public class BananaAdventureTimeDataGenerator implements DataGeneratorEntrypoint {
	@Override
